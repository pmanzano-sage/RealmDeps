...
class AddressCrud : AndroidTestCase() {
    ...
    fun testValidation() {
        ...
        val invalidEnity = Address(id, SyncStatus.SYNC_SUCCESS, street1Updated, street2Updated, "town", "county", "postCode", invalidItem2, invalidItem1)

        try {
            dataManager.save(invalidEnity)
    ...
    private fun <T : Dto> createInvalidEntity(clazz: Class<T>, id: String): T {
